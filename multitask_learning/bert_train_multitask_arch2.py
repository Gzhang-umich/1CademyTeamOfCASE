...
class BertCausalityModel(transformers.PreTrainedModel):
    ...
    @classmethod
    def create(cls):
        entailment_model = AutoModelForSequenceClassification.from_pretrained('adamnik/bert-entailment-detection')
        event_detection_model = AutoModelForSequenceClassification.from_pretrained('adamnik/bert-event-detection')
...
def main():
    ...
    causality_model = BertCausalityModel.create()

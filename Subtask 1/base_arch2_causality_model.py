...
class ClassifierHead_base(nn.Module):
    def __init__(self, dropout):
        super(ClassifierHead_base, self).__init__()
...
class CausalityModel_base(transformers.PreTrainedModel):
    def __init__(self, entailment_model, event_detection_model):
        ...
        self.classifer_head = ClassifierHead_base(self.dropout)

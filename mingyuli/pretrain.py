...
class ModelTrainer:
    ...
    def __init__(self, args):
        ...
        self.tokenized_train_set = tokenize_data(load_csv(self.args.train_set), self.tokenizer)
        self.tokenized_dev_set = tokenize_data(load_csv(self.args.dev_set), self.tokenizer)
    ...
    def get_training_args(self):
        ...
        training_args.push_to_hub = self.args.push_to_hub
        training_args.hub_model_id = "fcx-kilig/pretrain1"
...
def main():
    ...
    parser.add_argument("-dev_set",
                        help = ".csv dataset to used for evaluation",
                        required = True,
                        type = str)
